...
class GameLoop(settings.Settings):
    def __init__(self):
        ...
        self.tetrominoes = game_logic.tetrominoes.Tetrominoes()
    ...
    def loop(self):
        while True:
            ...
            self.tetrominoes.move_tetrominoe(self.tetrominoes_movement.move_tetrominoe_right,
            ...
            if self.tetrominoes.falling_tetrominoe.y >= 900-90:
                self.tetrominoes.falling_tetrominoe_landed()
                self.tetrominoes.create_new_tetrominoe()

            # draws tetrominoes
            self.game_gui.draw_window(
                self.tetrominoes.falling_tetrominoe, self.tetrominoes.landed_tetrominoes)
